...
<div class="mdui-container-fluid">
	...
	<div class="mdui-typo">
	  <h1> 离线上传<small>需开启aria2的RPC功能搭建rclone</small></h1>
	</div>
    ...
    <ul id="task-contextmenu" class="dropdown-menu">
      ...
      <li class="task-move"><a href="#" id="menuMoveEnd" >移至末尾</a></li>
    </ul>
    ...
    <div class="modal-body">
      ...
      <form id="add-task-uri">
        <div class="input-append">
          <input type="text" name="uri" id="uri-input" class="input-clear" placeholder="HTTP, FTP or Magnet" /><span><a id="torrent-up-btn" class="btn">上传 Torrent<input type="file" id="torrent-up-input" /></a></span>
        </div>
    ...
    <div class="modal-body">
      <form id="setting-form" class="form-horizontal">
        <fieldset>
          ...
          <div class="control-group">
            <label class="control-label">完成提示</label>
            <div class="controls">
              <label class="radio inline">
                <input type="radio" name="finish_notification" value="1" checked> 使能
              </label>
              <label class="radio inline">
