    ...
    foreach ($filess as $part) {
        if ('.' == $part ||'..' == $part||'default.php' == $part||'default.php' == $part||'uploads.php' == $part||'uploaded.php' == $part||'base.php' == $part||".DS_Store"==$part) continue;
             ...
             $v=str_replace(".php","",$part);
              ...
              echo 
            ' <link rel="prefetch" href="/'.config("root_path").$v.'/">';
            
        echo '<a href="/'.config("root_path").$v.'/" class="mdui-list-item mdui-ripple">
...
?>
<?php e(config('drawer'));?><a href="https://github.com/742481030/superone" class="mdui-list-item mdui-ripple ">
 ...
 <ul class="mdui-menu" id="menu">
     <?php  if($_COOKIE["moveitem"]): ?>
      <li class="mdui-menu-item">
        ...
        <?php if(is_login()): ?>
         <li class="mdui-menu-item">
            <a href="/src/template/admin/loginout.php" class="mdui-ripple">退出</a>
        </li>
          <?php endif;?>
    </ul>
        <upload>
    ...
    <script src="https://1cdn.jsdelivr.net/npm/aplayer/dist/APlayer.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/axios/axios@0.19.2/dist/axios.min.js"></script>
    <script src="https://cdn.jsdelivr.net/combine/npm/js-cookie@2/src/js.cookie.min.js,gh/cdngod/texiao@1.0/js/snow.js"></script>
        
          <script src="/src/template/nexmoe/manger-11.js"></script>
